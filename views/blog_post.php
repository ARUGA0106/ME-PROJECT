  ...
  <div class="intro intro-single route bg-image" style="background-image: url(../assets/img/back_1.jpg)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="intro-title mb-4">write a blog post</h2>
      ...
      <div class="container">
        ...
        <div class="portfolio-description">
           ...
           <p class="text-justify">
              ...
              Your experience and contribution empowers individuals with the knowledge and skills to navigate the digital world securely. 
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">blog sheet</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="message_time" rows="50" data-rule="required"> 
                    </div>
                  </div>
                   <div class="col-md-12">
             ...
             <button type="submit" name="submit" class="button button-a button-big button-rouded">submit post</button>
            </div>
             </form>
            </div>
          </div>
